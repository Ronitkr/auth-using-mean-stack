...
let LoginComponent = class LoginComponent {
    constructor(errMsg, api, route, ngZone) {
        this.errMsg = errMsg;
        this.api = api;
        this.route = route;
    }
...
let RegisterComponent = class RegisterComponent {
    constructor(validate, errMsg, authApi, route, ngZone) {
...
let AuthService = class AuthService {
    ...
    getProfile() {
        ...
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set('Authorization', this.authToken);
